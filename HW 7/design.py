...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/sharp_calculate_black_24dp.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.lbl_temp.setMinimumSize(QSize(0, 0))
...
"border: none;")
        ...
        self.btn_7.setIconSize(QSize(24, 24))
        ...
        self.btn_mul.setIconSize(QSize(24, 24))
        ...
        self.btn_8.setIconSize(QSize(24, 24))
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/sharp_backspace_white_24dp.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.btn_9.setIconSize(QSize(24, 24))
        ...
        self.btn_ce.setIconSize(QSize(24, 24))
